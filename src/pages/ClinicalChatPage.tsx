      ...
      >
        ...
        >
          ...
          <div className="p-4 border-b border-black/5 bg-cream/90 backdrop-blur-sm z-10 shrink-0 shadow-[0_4px_20px_rgba(0,0,0,0.02)]">
            <div className="flex items-center justify-between mb-3 px-1">
              ...
              <button className="text-ink-soft hover:text-ink-main transition">
          ...
          <div className="p-4 border-t border-black/5 bg-cream shrink-0">
            <div className="relative flex items-center bg-paper border border-black/10 rounded-full shadow-sm focus-within:ring-2 focus-within:ring-sand-dark/20 focus-within:border-sand-dark/30 transition-all p-1.5">
              <button className="w-10 h-10 rounded-full flex items-center justify-center text-ink-muted hover:text-ink-main hover:bg-cream transition shrink-0">
        ...
        >
          ...
          <div className="flex justify-end items-center gap-3 mb-4 shrink-0">
            <button className="px-4 py-2 bg-paper border border-black/10 rounded-lg text-sm font-medium text-ink-main shadow-sm hover:bg-cream transition flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <button className="px-5 py-2 bg-ink-main text-paper rounded-lg text-sm font-medium shadow-[0_4px_14px_rgba(44,41,38,0.2)] hover:bg-ink-main/90 transition flex items-center gap-2">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
